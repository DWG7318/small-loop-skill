...
- 补充信息或采用其他验证方式；
- 调整模型能力、CELL、施工顺序或技术路线；
- 需要 Owner 掌握的电脑、工具、账号或环境时，提交推荐方案和最低必要授权请求；
- Checker 将过大的 CELL 一分为二，并保留原验收目标；
- 由上一级成员恢复通讯或成员；
- 需要上级决定时激活 Supervisor，由其一次性调整计划、决定 D1 豁免，或提交已经成形的 Owner 授权建议，再把日常工作交还 Checker。
...
7. 在真实 Owner 权限问题出现时提交推荐方案和最低必要授权请求；
